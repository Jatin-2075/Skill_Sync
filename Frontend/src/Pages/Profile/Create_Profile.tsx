                            ...
                            <div className="education-card">
                                ...
                                <div className="input-row">
                                    <div className="general-option">
                                        ...
                                        <select name="currentstatus" required onChange={handleStudent}>
                                    ...
                                    <div className="general-option">
                                        ...
                                        <select name="level" required onChange={handleStudent}>
                                    ...
                                    <div className="general-option">
                                        ...
                                        <input name="college" required onChange={handleStudent} placeholder="Ex. IIT Mandi" type="text" />
                                    </div>
                                </div>
                                <div className="input-row">
                                    <div className="general-option">
                                        <label>Year</label>
                                        <input name="year" required onChange={handleStudent} placeholder="ex. 2" type="text" />
                                    </div>
                                    <div className="general-option">
                                        <label>Branch</label>
                                        <input name="branch" required onChange={handleStudent} placeholder="ex. Mathematics and Computing" type="text" />
                                    </div>
                                </div>
                                <div className="input-row">
                                    <div className="general-option">
                                        <label>Passing Year</label>
                                        <input name="passingyear" required onChange={handleStudent} placeholder="ex. 2028" type="text" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="working-professional-card">
                                ...
                                <div className="input-row">
                                    <div className="general-option">
                                        ...
                                        <input name="preferredrole" required onChange={handleWork} placeholder="ex. Web Developer" type="text" />
                                    </div>
                                    <div className="general-option">
                                        <label>Working Profile</label>
                                        <select className="select-student" name="workingprofile" required onChange={handleWork}>
                                            <option className="option-student" value=""></option>
                                    ...
                                    <div className="general-option">
                                        ...
                                        <input name="company" required onChange={handleWork} placeholder="ex. Google" type="text" />
                                    </div>
                                </div>
                                <div className="input-row">
                                    <div className="general-option">
                                        <label>Years of Experience</label>
                                        <input name="yearexpereience" required onChange={handleWork} placeholder="ex. 2" type="text" />
                                    </div>
                                </div>
